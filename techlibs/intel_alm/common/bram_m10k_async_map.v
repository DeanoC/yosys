// Registered ramstyle=M10K SDP.  CLK2 is the live read clock; B1EN is the
// registered-read enable.  Do not set CFG_ASYNC_READ.
module \$__MISTRAL_M10K_SYNC_10_ (PORT_W_CLK, PORT_W_CLK_EN, PORT_W_ADDR,
    PORT_W_WR_DATA, PORT_W_WR_EN, PORT_R_CLK, PORT_R_CLK_EN, PORT_R_ADDR,
    PORT_R_RD_DATA, PORT_R_RD_EN);
parameter INIT = 0;
input PORT_W_CLK, PORT_W_CLK_EN, PORT_W_WR_EN;
input PORT_R_CLK, PORT_R_CLK_EN, PORT_R_RD_EN;
...
module \$__MISTRAL_M10K_SYNC_20_ (PORT_W_CLK, PORT_W_CLK_EN, PORT_W_ADDR,
    PORT_W_WR_DATA, PORT_W_WR_EN, PORT_R_CLK, PORT_R_CLK_EN, PORT_R_ADDR,
    PORT_R_RD_DATA, PORT_R_RD_EN);
parameter INIT = 0;
input PORT_W_CLK, PORT_W_CLK_EN, PORT_W_WR_EN;
...
module \$__MISTRAL_M10K_SYNC_40_ (PORT_W_CLK, PORT_W_CLK_EN, PORT_W_ADDR,
    PORT_W_WR_DATA, PORT_W_WR_EN, PORT_R_CLK, PORT_R_CLK_EN, PORT_R_ADDR,
    PORT_R_RD_DATA, PORT_R_RD_EN);
parameter INIT = 0;
input PORT_W_CLK, PORT_W_CLK_EN, PORT_W_WR_EN;
...
wire write_enable = PORT_W_CLK_EN && PORT_W_WR_EN;
MISTRAL_M10K #(.CFG_ABITS(8), .CFG_DBITS(40), .CFG_DUAL_CLOCK(1),
    .INIT(INIT)) _TECHMAP_REPLACE_ (
    .CLK1(PORT_W_CLK), .CLK2(PORT_R_CLK),
    .A1ADDR(PORT_W_ADDR), .A1DATA(PORT_W_WR_DATA), .A1EN(write_enable),
    .B1ADDR(PORT_R_ADDR), .B1DATA(PORT_R_RD_DATA),
...
module \$__MISTRAL_M10K_SYNC_BYTE_ (PORT_W_CLK, PORT_W_CLK_EN, PORT_W_ADDR,
    PORT_W_WR_DATA, PORT_W_WR_EN, PORT_W_WR_BE, PORT_R_CLK, PORT_R_CLK_EN,
    PORT_R_ADDR, PORT_R_RD_DATA, PORT_R_RD_EN);
parameter INIT = 0;
input PORT_W_CLK, PORT_W_CLK_EN, PORT_W_WR_EN;
input PORT_R_CLK, PORT_R_CLK_EN, PORT_R_RD_EN;
...
MISTRAL_M10K #(.CFG_ABITS(9), .CFG_DBITS(20), .CFG_BYTE_ENABLE(1),
    ...
    .B1DATA(PORT_R_RD_DATA), .ACLR0(1'b0), .ACLR1(1'b0));
endmodule

// Registered true-dual-port ramstyle=M10K.  Both clocks stay live; do not
// set CFG_ASYNC_READ.  The TDP primitive is registered unless that flag is set.
module \$__MISTRAL_M10K_SYNC_TDP_ (
